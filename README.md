...
- I needed to change the scale and orientation of my .fbx file, so I have import the dog.fbx file inside the carla after running `make launch`, and then in ImportAssets, I modified the scale and orientation.
